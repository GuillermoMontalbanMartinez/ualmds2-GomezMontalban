...
<vaadin-vertical-layout style="width: 100%; height: 100%;" id="vaadinVerticalLayout">
 ...
 <vaadin-vertical-layout theme="spacing" style="height: 100%; width: 100%;" id="vaadinVerticalLayout1">
  <vaadin-horizontal-layout theme="spacing" style="margin-left: var(--lumo-space-xl); padding-left: var(--lumo-space-m);">
   <p>Destinatario : </p>
   <vaadin-text-field id="destinatarioText" style="align-self: center; margin-left: var(--lumo-space-l);"></vaadin-text-field>
  ...
  <vaadin-horizontal-layout theme="spacing" style="margin-left: var(--lumo-space-xl); padding-left: var(--lumo-space-m);" id="vaadinHorizontalLayout">
   <p id="p1">Asunto : </p>
   <vaadin-text-field id="asuntoText" style="align-self: center; margin-left: var(--lumo-space-xl); padding-left: var(--lumo-space-m);"></vaadin-text-field>
  </vaadin-horizontal-layout>
