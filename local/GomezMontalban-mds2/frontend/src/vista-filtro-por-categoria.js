...
<vaadin-vertical-layout style="width: 100%;">
 ...
 <vaadin-vertical-layout theme="spacing" style="align-self: center; align-items: center; justify-content: center; flex-shrink: 0; margin: var(--lumo-space-m);" id="selectLayout"></vaadin-vertical-layout>
</vaadin-vertical-layout>
`;
    }
