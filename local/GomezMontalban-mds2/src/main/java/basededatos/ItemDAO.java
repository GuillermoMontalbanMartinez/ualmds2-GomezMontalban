...
public class ItemDAO {
	public static Item loadItemByORMID(int id_item) throws PersistentException {
		try {
			PersistentSession session = TFGómezMontalbánPersistentManager.instance().getSession();
			return loadItemByORMID(session, id_item);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Item getItemByORMID(int id_item) throws PersistentException {
		try {
			PersistentSession session = TFGómezMontalbánPersistentManager.instance().getSession();
			return getItemByORMID(session, id_item);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item loadItemByORMID(int id_item, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = TFGómezMontalbánPersistentManager.instance().getSession();
			return loadItemByORMID(session, id_item, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item getItemByORMID(int id_item, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = TFGómezMontalbánPersistentManager.instance().getSession();
			return getItemByORMID(session, id_item, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item loadItemByORMID(PersistentSession session, int id_item) throws PersistentException {
		try {
			return (Item) session.load(basededatos.Item.class, new Integer(id_item));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item getItemByORMID(PersistentSession session, int id_item) throws PersistentException {
		try {
			return (Item) session.get(basededatos.Item.class, new Integer(id_item));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item loadItemByORMID(PersistentSession session, int id_item, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Item) session.load(basededatos.Item.class, new Integer(id_item), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item getItemByORMID(PersistentSession session, int id_item, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Item) session.get(basededatos.Item.class, new Integer(id_item), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryItem(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From basededatos.Item as Item");
		if (condition != null)
	...
	public static Item createItem() {
		return new basededatos.Item();
	}
	
	public static boolean save(basededatos.Item item) throws PersistentException {
		try {
			TFGómezMontalbánPersistentManager.instance().saveObject(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basededatos.Item item) throws PersistentException {
		try {
			TFGómezMontalbánPersistentManager.instance().deleteObject(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(basededatos.Item item)throws PersistentException {
		try {
			if (item.getEsta_asociado_a_una_compra() != null) {
				item.getEsta_asociado_a_una_compra().setTiene_item(null);
			}
			
			if (item.getEsta_asociado_a_un_producto() != null) {
				item.getEsta_asociado_a_un_producto().setTiene_item(null);
			}
	...
	public static boolean deleteAndDissociate(basededatos.Item item, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (item.getEsta_asociado_a_una_compra() != null) {
				item.getEsta_asociado_a_una_compra().setTiene_item(null);
			}
	...
	public static boolean refresh(basededatos.Item item) throws PersistentException {
		try {
			TFGómezMontalbánPersistentManager.instance().getSession().refresh(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basededatos.Item item) throws PersistentException {
		try {
			TFGómezMontalbánPersistentManager.instance().getSession().evict(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
