...
public class Compra_pendienteDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public Compra_pendienteDetachedCriteria() {
		super(basededatos.Compra_pendiente.class, basededatos.Compra_pendienteCriteria.class);
	...
	public Compra_pendienteDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, basededatos.Compra_pendienteCriteria.class);
		id_compra = new IntegerExpression("id_compra", this.getDetachedCriteria());
		tiene_itemId = new IntegerExpression("tiene_item.id_item", this.getDetachedCriteria());
		tiene_item = new AssociationExpression("tiene_item", this.getDetachedCriteria());
		estado_compra = new IntegerExpression("estado_compra", this.getDetachedCriteria());
	...
	public Compra_pendiente uniqueCompra_pendiente(PersistentSession session) {
		return (Compra_pendiente) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Compra_pendiente[] listCompra_pendiente(PersistentSession session) {
