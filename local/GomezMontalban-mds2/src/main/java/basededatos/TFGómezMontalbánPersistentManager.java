...
public class TFGómezMontalbánPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "TFGómezMontalbán";
	...
	private TFGómezMontalbánPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TFGómezMontalbánPersistentManager();
		}
