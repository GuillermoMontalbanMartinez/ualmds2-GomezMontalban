...
;
	...
	public void mostrar_productos_comprados() throws PersistentException {
		...
		for(Compra c : compraArrayList) {
			...
			p.getImagen().setSrc(c.getTiene_item().getEsta_asociado_a_un_producto().tiene_fotos.toArray()[0].getLink_foto());
	...
	public void setUsuario(String usuario) throws PersistentException {
		basededatos.Cibernauta_registrado[] cb = basededatos.Cibernauta_registradoDAO.listCibernauta_registradoByQuery(null, null);
